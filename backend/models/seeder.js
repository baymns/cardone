...
dotenv.config();
console.log(`mongodb+srv://Sergey:${process.env.MONGO_DB_KEY}@cluster0-aqh9k.mongodb.net/service?retryWrites=true&w=majority`);
mongoose.connect(
  `mongodb+srv://Sergey:${process.env.MONGO_DB_KEY}@cluster0-aqh9k.mongodb.net/service?retryWrites=true&w=majority`,
  // 'mongodb://localhost:27017/cardone',
  {
...
(async () => {
  ...
  try {
    const response = await fetch(
      encodeURI(
        `https://search-maps.yandex.ru/v1/?apikey=8fbe0a2c-1818-447d-bae8-98146681cb27&text=автосервис&type=biz&lang=ru_RU&ll=${longitude},${latitude}&spn=0.052069,0.050552&results=500`,
      ),
    );
